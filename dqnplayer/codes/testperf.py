...
from DeepQNetworkPlayer1 import DeepQNetworkPlayer
from DeepQNetworkPlayer1000 import DeepQNetworkPlayer1000
...
def testperf(agent_name1, agent1, agent_name2, agent2):
    ...
    config.register_player(name=agent_name2, algorithm=DeepQNetworkPlayer())
...
def parse_arguments():
    ...
    parser.add_argument('-n1', '--agent_name1', help="Name of agent 1", default="HonestPlayer", type=str)
    parser.add_argument('-a1', '--agent1', help="Agent 1", default=HonestPlayer())
    parser.add_argument('-n2', '--agent_name2', help="Name of agent 2", default="DeepQNetworkPlayer", type=str)
    parser.add_argument('-a2', '--agent2', help="Agent 2", default=DeepQNetworkPlayer())
