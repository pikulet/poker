...
class Cfr:
    """Creates new heads-up limit Texas hold'em poker (HULHE) poker using CFR algorithm which runs for specified number
    of iterations.
    """
    ...
    def __init__(self):
        ...
        self.player_count = const.NUM_PLAYERS
    ...
    # returns each players' utilities at the terminal node
